...
def sift_detector(new_image, image_template):
    ...
    # used for matching sift descriptors
    FLANN_INDEX_KDTREE = 0  # initialization value
    index_params = dict(algorithm=FLANN_INDEX_KDTREE, trees=3)  # more number of trees more complex, slow compute
    ...
    # improve flann matching accuracy
    # looks at matches from knnmatch , distance numpy function
    good_matches = []
    for m, n in matches:
