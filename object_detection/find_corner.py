...
harris_corners = cv2.cornerHarris(gray, 3, 3, 0.05)  # returns an array of corner locations
# these corners are tiny locations hence we need to dilate = add pixels to edges of the corners them or enlarge them
...
# thresholding to change the color of the corners that we are drawing on our image
...
# corners = cv2.goodFeaturesToTrack(gray, 100, 0.01, 150) # these parameters reduced corner detection
