...
result = cv2.matchTemplate(gray, template, cv2.TM_CCOEFF)  # array
min_val, max_val, min_loc, max_loc = cv2.minMaxLoc(result)  # coordinates of bounding box of matched portion
