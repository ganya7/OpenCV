...
for c in sorted_contours:
    cv2.drawContours(orginal_image, [c], -1, (255, 0, 0),
                     3)  # drawing contours over og img, -1 indicates drawing all contours even though in each case its a single contour
    cv2.waitKey(0)
...
for (i, c) in enumerate(contours_left_to_right):
    ...
    (x, y, w, h) = cv2.boundingRect(c)  # cropping the contours
