...
# max value parameter is the value when the threshold is crossed
...
# ### Is there a better way off thresholding? ie selection of threshold value
#
...
# block size should be odd nos, constant that is subtracted from the mean
#
